...
\foreach \a [count=\n] in {
    ...
    LL,     % Elizabeth Lanphere
    SC,      % Stefano Cucurachi
    CFRB,    % Carlos Felipe Blanco
...
\foreach \y [count=\n] in {
    ...
    {\lo,\hi,\lo,\hi}, % Conceptualization
    {\hi,\mid,0,0},      % Formal analysis
    {\hi,\mid,0,0},        % Investigation
    {\hi,\mid,0,0},      % Methodology
    {0,0,0,0},          % Resources (none specified)
    {\hi,\mid,0,0},      % Software
    {\hi,\mid,0,0},        % Writing---Original Draft
    {\hi,\hi,\hi,\hi},  % Writing---Reviewing and Editing
